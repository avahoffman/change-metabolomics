...
plot_main_effects <-  function(fit, name) {
  ...
  dimnames(posterior)$parameters <- gsub("B1","Species effect",dimnames(posterior)$parameters)
  dimnames(posterior)$parameters <- gsub("B2","Nitrogen effect",dimnames(posterior)$parameters)
  dimnames(posterior)$parameters <- gsub("B3","Interaction effect",dimnames(posterior)$parameters)
